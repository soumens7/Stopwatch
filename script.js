...
function stopWatch() {
  ...
  if (milliseconds == 1000) {
    //when milliseconds reaches to 1000, it will to 00 and increase the seconds by 1
    milliseconds = 0o0;
    seconds++;
    if (seconds == 60) {
      //when seconds counter reaches to 60, it will change the value to 0 and increase minutes by 1
      seconds = 0;
      minutes++;
      if (minutes == 60) {
        //when minutes counter reaches to 60, it will change the value to 0 and increase hours by 1
        minutes = 0;
        hours++;
      }
    }
